...
![image-20231224145801613](assets/HydGER9k7pleIbM.jpg)因为泛型本身就是对某些待定类型的简单处理，如果都明确要使用什么类型了，那大可不必使用泛型。还有，不能通过这个不确定的类型变量就去直接创建对象：

![image-20231224145942619](assets/bvEcJO6hzWVILm7.jpg)

还有，由于泛型在创建时就已经确定，因此即使都是Score类，由于类型参数的不同也会导致不通用：

![image-20231224150118514](assets/XiAGHKbeaMDcTt6.jpg)
...
![image-20231224174024496](assets/Arojew9z7OnYigW.jpg)
...
![image-20231225000422558](assets/Zr6owjlEa8ekDAx.jpg)

但是现在存在这样一个问题，我们如果使用某个类型的父类呢，会不会出现类型不匹配的情况？

![image-20231225000541465](assets/w2H5ychAIOYX9S6.jpg)
...
![image-20231224155321582](assets/X7T8Uq5KEkgsASr.jpg)

![image-20231225004519670](assets/ok4fegPIxcFO9Tl.jpg)
...
![image-20231225020935723](assets/U7IjSuzdDLMGBHs.jpg)
...
![image-20231225010418319](assets/Hm81fOVTp5XcR24.jpg)
...
![image-20231225022706721](assets/yGZNjz59bq81LW2.jpg)
